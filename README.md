...
This repository is the ZIP Pointer Service. It points to ZIPs hosted by Pillars.  In order to add a ZIP repository Pillars should submit a pull request.  ZIP repositories must meet the following criteria to be added:
